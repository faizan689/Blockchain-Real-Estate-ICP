          ...
          <div className="space-y-6">
            {activeProposals.length === 0 ? (
              ...
              activeProposals.map((proposal) => {
                ...
                const totalPower = proposal.totalVotingPower ?? 0;
                const votingProgress = totalPower > 0 ? (totalVotes / totalPower) * 100 : 0;
                ...
                const userVotingPower = proposal.id === 1 ? 1247 : 800;
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="ml-6 text-right">
                          <div className="text-2xl font-bold text-gray-900 dark:text-white">
                            {(userVotingPower ?? 0).toLocaleString()}
                          </div>
                      ...
                      <div className="mb-6">
                        <div className="flex justify-between text-sm mb-2">
                          ...
                          <span className="text-gray-900 dark:text-white">
                            {(totalVotes ?? 0).toLocaleString()} / {(totalPower ?? 0).toLocaleString()} tokens voted
                          </span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="flex items-center justify-between p-3 bg-secondary/10 rounded-lg">
                            ...
                            <span className="text-secondary font-bold">
                              {(proposal.votesFor ?? 0).toLocaleString()} ({forPercentage.toFixed(1)}%)
                            </span>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-destructive/10 rounded-lg">
                            <span className="text-destructive font-medium">Against</span>
                            <span className="text-destructive font-bold">
                              {(proposal.votesAgainst ?? 0).toLocaleString()} ({againstPercentage.toFixed(1)}%)
                            </span>
                          </div>
                        </div>
                      </div>
